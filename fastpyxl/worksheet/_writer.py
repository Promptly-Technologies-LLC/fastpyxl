...
from fastpyxl.xml.functions import xmlfile
from fastpyxl.xml.constants import SHEET_MAIN_NS

from fastpyxl.comments.comment_sheet import CommentRecord
from fastpyxl.packaging.relationship import Relationship, RelationshipList
...
from fastpyxl.cell._writer import write_cell


ALL_TEMP_FILES = []

@atexit.register
def _fastpyxl_shutdown():
...
class WorksheetWriter:
        ...
        with xf.element("row", attrs):
            ...
            for cell in row:
                ...
                if (
                    ...
                    continue
                write_cell(xf, self.ws, cell, styled)
    ...
    def write_sort(self):
        ...
        fastpyxl never reads it from existing files
        """
        pass
