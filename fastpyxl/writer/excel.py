...
from fastpyxl.styles.stylesheet import write_stylesheet
from fastpyxl.worksheet._writer import WorksheetWriter
...
def save_workbook(workbook, filename):
    ...
    :type workbook: :class:`fastpyxl.workbook.Workbook`
