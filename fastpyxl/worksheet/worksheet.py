...
from fastpyxl.formatting.formatting import ConditionalFormattingList
...
class Worksheet(_WorkbookChild):
    ...
    use :func:`fastpyxl.workbook.Workbook.create_sheet` instead
