...
fastpyxl tries very hard to implement the OOXML specification correctly, you
should be able to do most things quite easily. To things easier to read,
fastpyxl includes some aliases for some of the more obscure element or
...
for the desired effect. Fortunately, because fastpyxl is very close to the
