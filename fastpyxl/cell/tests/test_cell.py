...
from fastpyxl.cell.cell import ERROR_CODES, get_time_format


@pytest.fixture
def DummyWorksheet():
    from fastpyxl.utils.indexed_list import IndexedList
    from fastpyxl.utils.datetime  import CALENDAR_WINDOWS_1900
...
def test_fill(DummyWorksheet, Cell):
    from fastpyxl.styles import PatternFill
...
def test_border(DummyWorksheet, Cell):
    from fastpyxl.styles import Border
    border = Border()
    ws = DummyWorksheet
...
def test_alignment(DummyWorksheet, Cell):
    from fastpyxl.styles import Alignment
...
def test_protection(DummyWorksheet, Cell):
    from fastpyxl.styles import Protection
